...
class CondicoesPagamento extends BaseController
{
    ...
    public function fetch()
    {
        ...
        foreach ($condicoes as $condicao) {
            if (APP_THEME == 'mentor') {
                $act_view = '<button title="Visualizar Condição de Pagamento" data-id="'.$condicao->id.'" data-modulo="view" class="btn btn-sm btn-icon btn-outline-dark btn-round btn-view"><i class="ti ti-eye"></i></button>';
                $act_edit = '<button title="Editar Condição de Pagamento" data-id="'.$condicao->id.'" data-modulo="edit" class="btn btn-sm btn-icon btn-outline-primary btn-round btn-edit"><i class="ti ti-pencil"></i></button>';

                $status = ($condicao->active == true ? '<span class="btn btn-sm btn-icon btn-round btn-inverse-success"><i class="ti ti-unlock" title="Ativo"></i></span>' : '<span class="btn btn-sm btn-icon btn-round btn-inverse-danger"><i class="ti ti-lock" title="Inativo"></i></span>');
            } else {
    ...
    public function insert()
    {
        ...
        if (isset($post['entrada'])) {
            $post['entrada'] = ($post['entrada'] == 'on' ? true : false);
        } else {
            $post['entrada'] = false;
        }
    ...
    public function show(int $id = null)
    {
        ...
        $data = [
            'title' => 'Visualizar',
            'table' => $condicao,
            'tabelas' => $this->tabelaModel->getTabelaById($condicao->tabela_id),
        ];
