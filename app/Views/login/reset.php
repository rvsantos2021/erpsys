...
<body>
        ...
        <div class="center-sign">
            ...
            <div class="panel panel-sign">
                <div class="panel-title-sign mt-xl text-right">
                    <h2 class="title text-uppercase text-bold m-none"><i class="fa fa-user mr-xs"></i> Redefinir a Senha</h2>
                </div>
                <div class="panel-body">
                    <?php echo form_open('/', ['id' => 'resetForm', 'class' => 'form-validate'], ['token' => $token]) ?>
                    ...
                    <div class="form-group mb-lg">
                        <label class="pull-left">Confirmação de Senha</label>
                        <div class="input-group input-group-icon">
                            <input name="password_confirmation" type="password" class="form-control input-lg" placeholder="******" autocomplete="current-password" required />
                            <span class="input-group-addon">
                                <span class="icon icon-lg">
                                    <i class="fa fa-lock"></i>
                                </span>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4 text-right">
                            <button type="submit" class="btn btn-warning fixed-button-width hidden-xs btn-reset">Redefinir</button>
                        </div>
                    </div>
                    <?php echo form_close(); ?>
                    <hr>
    ...
    <!-- login app -->
    <script src="<?php echo site_url('assets/'); ?>javascripts/reset.js"></script>
</body>
