                ...
                <nav class="navbar navbar-expand-md">
                    ...
                    <div class="navbar-header d-flex align-items-center">
                        ...
                        <a class="navbar-brand" href="index.html">
                            <img src="<?= site_url('mentor/assets/'); ?>img/logo.png" class="img-fluid logo-desktop" alt="logo" />
                            <img src="<?= site_url('mentor/assets/'); ?>img/logo-icon.png" class="img-fluid logo-mobile" alt="logo" />
                        </a>
                    </div>
                                                ...
                                                <ul class="scrollbar scroll_dark max-h-240">
                                                        ...
                                                        <a href="javascript:void(0)">
                                                            <div class="notification d-flex flex-row align-items-center">
                                                                <div class="notify-icon bg-img align-self-center">
                                                                    <img class="img-fluid" src="<?= site_url('mentor/assets/'); ?>img/avtar/03.jpg" alt="user3">
                                                                </div>
                                                    ...
                                                    <li>
                                                        <a href="javascript:void(0)">
                                                            <div class="notification d-flex flex-row align-items-center">
                                                                <div class="notify-icon bg-img align-self-center">
                                                                    <img class="img-fluid" src="<?= site_url('mentor/assets/'); ?>img/avtar/01.jpg" alt="user">
                                                                </div>
                                                                <div class="notify-message">
                                                    ...
                                                    <li>
                                                        <a href="javascript:void(0)">
                                                            <div class="notification d-flex flex-row align-items-center">
                                                                <div class="notify-icon bg-img align-self-center">
                                                                    <img class="img-fluid" src="<?= site_url('mentor/assets/'); ?>img/avtar/02.jpg" alt="user2">
                                                                </div>
                                                                <div class="notify-message">
                                                    ...
                                                    <li>
                                                        <a href="javascript:void(0)">
                                                            <div class="notification d-flex flex-row align-items-center">
                                                                <div class="notify-icon bg-img align-self-center">
                                                                    <img class="img-fluid" src="<?= site_url('mentor/assets/'); ?>img/avtar/04.jpg" alt="user4">
                                                                </div>
                                                                <div class="notify-message">
                                                    ...
                                                    <li>
                                                        <a href="javascript:void(0)">
                                                            <div class="notification d-flex flex-row align-items-center">
                                                                <div class="notify-icon bg-img align-self-center">
                                                                    <img class="img-fluid" src="<?= site_url('mentor/assets/'); ?>img/avtar/05.jpg" alt="user5">
                                                                </div>
                                                                <div class="notify-message">
                                                    ...
                                                    <li>
                                                        <a href="javascript:void(0)">
                                                            <div class="notification d-flex flex-row align-items-center">
                                                                <div class="notify-icon bg-img align-self-center">
                                                                    <img class="img-fluid" src="<?= site_url('mentor/assets/'); ?>img/avtar/06.jpg" alt="user6">
                                                                </div>
                                                                <div class="notify-message">
                                ...
                                <li class="nav-item dropdown user-profile">
                                    <a href="javascript:void(0)" class="nav-link dropdown-toggle " id="navbarDropdown4" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <?php if (userIsLogged()->photo != null) { ?>
                                            <img src="<?= site_url('mentor/assets/'); ?>img/avtar/02.jpg" alt="avtar-img">
                                        <?php } else { ?>
                                            <img src="<?= site_url('mentor/assets/img/' . APP_LOGOICON); ?>" alt="avtar-img">
                                        <?php } ?>
                                    ...
                                    <div class="dropdown-menu animated fadeIn" aria-labelledby="navbarDropdown">
                                        <div class="bg-gradient px-4 py-3">
                                            <div class="d-flex align-items-center justify-content-between">
                                                <div class="mr-1">
                                                    <h4 class="text-white mb-0"><?= userIsLogged()->name; ?></h4>
                                                    <small class="text-white"><?= userIsLogged()->email; ?></small>
                                                </div>
                                                <a href="<?= site_url('logout'); ?>" class="text-white font-20 tooltip-wrapper" data-toggle="tooltip" data-placement="top" title="" data-original-title="Encerrar">
                                        ...
                                        <div class="p-4">
                                            ...
                                            <a class="dropdown-item d-flex nav-link" href="javascript:void(0)">
                                                <i class="fa fa-envelope pr-2 text-primary"></i> Caixa de Entrada
                                            ...
                                            <a class="dropdown-item d-flex nav-link" href="javascript:void(0)">
                                                <i class="fa fa-compass pr-2 text-warning"></i> Precisa de ajuda?
                                            </a>
                                            <div class="row mt-2">
                                                <div class="col">
                                                    <a class="bg-light p-3 text-center d-block" href="javascript:void(0)">
                                                        <i class="fe fe-mail font-20 text-primary"></i>
                                                        <span class="d-block font-13 mt-2">Mensagens</span>
                                                    </a>
                                                </div>
                                                <div class="col">
                                                    <a class="bg-light p-3 text-center d-block" href="javascript:void(0)">
                                                        <i class="fe fe-plus font-20 text-primary"></i>
                                                        <span class="d-block font-13 mt-2">Nova Mensagem</span>
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
