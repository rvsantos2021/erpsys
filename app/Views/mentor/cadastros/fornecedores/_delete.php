                    <div class="card-body pb-3 pt-4">
                        <div class="text-center">
                            <div class="pt-1 bg-img m-auto">
                                ...
                                <?php else : ?>
                                    <img src="<?= site_url("fornecedores/show_photo/$fornecedor->photo"); ?>" class="rounded-circle rounded-circle-60" alt="Foto do Fornecedor" />
                                <?php endif; ?>
                            </div>
                            <div class="mt-3">
                                ...
                                <ul class="nav justify-content-between mt-4 px-3 py-2">
                                    ...
                                    <li class="flex-fill">
                                        ...
                                        <p><?= formatDateTime($fornecedor->updated_at); ?></p>
                                    </li>
                                </ul>
                            </div>
