                        ...
                        <fieldset class="border pb-4 pr-4 pl-4 rounded">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="text" class="form-control" name="abreviatura" placeholder="Abreviatura" value="<?php echo $table->abreviatura; ?>" maxlength="5" required />
                                </div>
                                <div class="form-group col-md-3">
                                    <label>Quantidade</label>
                                    <input type="number" class="form-control text-right" name="quantidade" value="<?php echo $table->quantidade; ?>" required />
                                </div>
                            </div>
                        </fieldset>
                    </div>
