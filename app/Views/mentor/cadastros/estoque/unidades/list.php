    ...
    <div class="col-lg-12">
        <div class="card card-statistics">
            <div class="card-header">
                <button data-toggle="tooltip" data-original-title="Incluir Unidade" data-modulo="add" class="btn btn-sm btn-square btn-inverse-success fixed-button-width float-right btn-add">
                    ...
                    <table id="datatable" class="table mb-0" style="width: 100%;">
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th scope="col" class="text-center col-1">Abrev.</th>
                                <th scope="col" class="text-right col-1">Qtd.</th>
...
<!-- custom app -->
<script src="<?= site_url('mentor/assets/'); ?>js/estoque/unidades.js"></script>
<script src="<?= site_url('mentor/assets/'); ?>js/common.js" data-route="unidades"></script>
<?= $this->endSection(); ?>