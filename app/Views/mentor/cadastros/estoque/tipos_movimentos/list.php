    ...
    <div class="col-lg-12">
        <div class="card card-statistics">
            <div class="card-header">
                <button data-toggle="tooltip" data-original-title="Incluir Tipo de Produto" data-modulo="add" class="btn btn-sm btn-square btn-inverse-success fixed-button-width float-right btn-add">
                    ...
                    <table id="datatable" class="table mb-0" style="width: 100%;">
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th scope="col" class="text-center col-1">Movimento</th>
                                <th scope="col" class="text-center col-1">Mov. Estoque</th>
...
<div class="modal fade" id="modalView" tabindex="-1" role="dialog" aria-labelledby="modalView" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document" style="min-width: 45%">
...
<!-- custom app -->
<script src="<?php echo site_url('mentor/assets/'); ?>js/estoque/tipos-movimentos.js"></script>
<script src="<?php echo site_url('mentor/assets/'); ?>js/common.js" data-route="tiposmovimento"></script>
<?php echo $this->endSection(); ?>