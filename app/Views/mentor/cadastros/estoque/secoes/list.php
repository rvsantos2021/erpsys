    ...
    <div class="col-lg-12">
        <div class="card card-statistics">
            <div class="card-header">
                <button data-toggle="tooltip" data-original-title="Incluir Seção" data-modulo="add" class="btn btn-sm btn-square btn-inverse-success fixed-button-width float-right btn-add">
...
<!-- custom app -->
<script src="<?= site_url('mentor/assets/'); ?>js/estoque/secoes.js"></script>
<script src="<?= site_url('mentor/assets/'); ?>js/common.js" data-route="secoes"></script>
<?= $this->endSection(); ?>