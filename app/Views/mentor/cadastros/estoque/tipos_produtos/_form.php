                            ...
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input" id="produto" name="produto" <?php echo $table->produto == 1 ? 'checked' : ''; ?> />
                                        <label for="produto" class="form-check-label">Produto</label>
                                    </div>
                                </div>
                                <div class="form-group col-md-4">
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input" id="materia_prima" name="materia_prima" <?php echo $table->materia_prima == 1 ? 'checked' : ''; ?> />
                                        <label for="materia_prima" class="form-check-label">Matéria-Prima</label>
                                    </div>
                                </div>
                            </div>
                        </fieldset>
