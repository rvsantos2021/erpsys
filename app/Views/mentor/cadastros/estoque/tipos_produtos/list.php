                    ...
                    <table id="datatable" class="table mb-0" style="width: 100%;">
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th scope="col" class="text-center col-1">Produto</th>
                                <th scope="col" class="text-center col-1">Mat. Prima</th>
...
<!-- custom app -->
<script src="<?php echo site_url('mentor/assets/'); ?>js/estoque/tipos-produtos.js"></script>
<script src="<?php echo site_url('mentor/assets/'); ?>js/common.js" data-route="tiposproduto"></script>
<?php echo $this->endSection(); ?>