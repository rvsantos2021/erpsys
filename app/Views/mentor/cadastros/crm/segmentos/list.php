    ...
    <div class="col-lg-12">
        <div class="card card-statistics">
            <div class="card-header">
                <button data-toggle="tooltip" data-original-title="Incluir Segmento" data-modulo="add" class="btn btn-sm btn-square btn-inverse-success fixed-button-width float-right btn-add">
...
<!-- custom app -->
<script src="<?php echo site_url('mentor/assets/'); ?>js/crm/segmentos.js"></script>
<script src="<?php echo site_url('mentor/assets/'); ?>js/common.js" data-route="segmentos"></script>
<?php echo $this->endSection(); ?>