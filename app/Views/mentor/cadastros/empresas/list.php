    ...
    <div class="col-lg-12">
        <div class="card card-statistics">
            <div class="card-header">
                <a href="<?= site_url('/empresas/add'); ?>" data-toggle="tooltip" data-original-title="Incluir Empresa" data-modulo="add" class="btn btn-sm btn-square btn-inverse-success fixed-button-width float-right">
