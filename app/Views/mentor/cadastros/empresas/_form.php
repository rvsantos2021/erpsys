                <div class="form-row">
                    <div class="form-group col-md-2">
                        <div class="text-center">
                            ...
                            <?php else : ?>
                                <img src="<?= site_url("empresas/show_photo/$table->photo"); ?>" class="rounded-circle" alt="Logo da Empresa" />
                            <?php endif; ?>
                        </div>
                        <div class="text-center">
                            <?php if ($method == "update") : ?>
                                <a href="#" class="btn btn-primary btn-sm mt-3 openPopupPhoto">Alterar Logo</a>
                            <?php endif; ?>
                        </div>
                    </div>
                    <div class="form-group col-md-10">
                        ...
                        <fieldset class="border pt-2 pb-4 pr-4 pl-4 mb-2 rounded">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-4">
                                    <label>Site</label>
                                    <input type="text" class="form-control" name="site" placeholder="Site" value="<?php echo $table->site; ?>" />
                                </div>
                            </div>
                        </fieldset>
                        <fieldset class="border pt-2 pb-4 pr-4 pl-4 mb-2 rounded">
