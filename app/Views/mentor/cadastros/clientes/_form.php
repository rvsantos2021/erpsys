                    ...
                    <div class="form-group col-md-2">
                        <div class="text-center">
                            <?php if ($table->photo == null) { ?>
                                <img src="<?php echo site_url('assets/images/avatar-cliente.png'); ?>" class="rounded-circle" alt="Cliente" />
                            <?php } else { ?>
                                <img src="<?php echo site_url("clientes/show_photo/$table->photo"); ?>" class="rounded-circle" alt="Foto do Cliente" />
                            <?php } ?>
                        </div>
                        <div class="text-center">
