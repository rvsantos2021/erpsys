    ...
    <div class="col-lg-12">
        <div class="card card-statistics">
            <div class="card-header">
                <a href="<?= site_url('/clientes'); ?>" data-toggle="tooltip" data-original-title="Voltar" class="btn btn-sm btn-square btn-inverse-primary fixed-button-width float-right">
            ...
            <div class="card-body">
                ...
                <?php echo $this->include('mentor/cadastros/clientes/_form'); ?>
                <?php echo form_close(); ?>
            </div>
            <div class="card-footer">
                <div class="float-right">
                    ...
                    <a href="<?= site_url('/clientes'); ?>" data-toggle="tooltip" data-original-title="Voltar" class="btn btn-sm btn-square btn-inverse-primary fixed-button-width">
                        <i class="ti ti-arrow-left"></i> Voltar
                    </a>
                </div>
            </div>
