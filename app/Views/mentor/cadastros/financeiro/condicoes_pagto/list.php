    ...
    <div class="col-lg-12">
        <div class="card card-statistics">
            <div class="card-header">
                <button data-toggle="tooltip" data-original-title="Incluir Condição de Pagamento" data-modulo="add" class="btn btn-sm btn-square btn-inverse-success fixed-button-width float-right btn-add">
                    ...
                    <table id="datatable" class="table mb-0" style="width: 100%;">
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th scope="col" class="text-center col-1">Entrada</th>
                                <th scope="col" class="text-center col-1">% Entrada</th>
                                <th scope="col" class="text-center col-1">Qtd. Parc.</th>
                                <th scope="col" class="text-center col-1">1ª Parc.</th>
                                <th scope="col" class="text-center col-1">Entre Parc.</th>
                                <th scope="col" class="col-1">Tabela</th>
...
<!-- custom app -->
<script src="<?php echo site_url('mentor/assets/'); ?>js/financeiro/condicoes-pgto.js"></script>
<script src="<?php echo site_url('mentor/assets/'); ?>js/common.js" data-route="condicoespgto"></script>
<?php echo $this->endSection(); ?>