                        ...
                        <div class="text-center">
                            <div class="pt-1 bg-img m-auto">
                                <?php if ($transportadora->photo == null) : ?>
                                    <img src="<?= site_url('assets/images/avatar-transportadora.png'); ?>" class="rounded-circle rounded-circle-60" alt="Fornecedor" />
                                <?php else : ?>
                                    <img src="<?= site_url("transportadoras/show_photo/$transportadora->photo"); ?>" class="rounded-circle rounded-circle-60" alt="Foto do Fornecedor" />
                                <?php endif; ?>
                            </div>
                            <div class="mt-3">
                                ...
                                <ul class="nav justify-content-between mt-4 px-3 py-2">
                                    ...
                                    <li class="flex-fill">
                                        ...
                                        <p><?= formatDateTime($transportadora->deleted_at); ?></p>
                                    </li>
                                </ul>
                            </div>
