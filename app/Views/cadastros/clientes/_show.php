                ...
                <fieldset class="border pt-4 pb-4 pr-4 pl-4 mb-2 rounded">
                    <div class="pr-4 pl-4">
                        ...
                        <div class="row row-content">
                            ...
                            <div class="col-md-2">
                                <span><?php echo $cliente->cnpj; ?></span>
                            </div>
                            <div class="col-md-2">
                                <span><?php echo $cliente->inscricao_estadual; ?></span>
                            </div>
                            <div class="col-md-6">

                            </div>
                            <div class="col-md-1">
                                <?php echo ($cliente->active == true ? '<span class="text-success">ATIVO</span>' : '<span class="text-danger">INATIVO</span>'); ?>
                            </div>
                        </div>
                        ...
                        <div class="row row-content">
                            <div class="col-md-8">
                                <span><?php echo $cliente->razao_social; ?></span>
                            </div>
                            <div class="col-md-4">
                                <span><?php echo $cliente->nome_fantasia; ?></span>
                            </div>
                        </div>
                        <div class="row row-space">
                        ...
                        <div class="row row-content">
                            ...
                            <div class="col-md-6">
                                <span><?php echo formatDate($cliente->data_nascimento); ?></span>
                            </div>
                        </div>
                        <div class="row row-space">
                        ...
                        <div class="row row-textarea">
                            <div class="col-md-12">
                                <span><?php echo $cliente->obs; ?></span>
                            </div>
                        </div>
                        <div class="row row-space">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <span class="text-primary">
                            <i class="fas fa-clock"></i><strong> Última Atualização:</strong> <?php echo formatDateTime($cliente->updated_at); ?>
                        </span>
                    </div>
                </div>
            </div>