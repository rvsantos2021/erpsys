...
<section class="panel panel-featured panel-featured-custom">
    <div class="panel-heading">
        ...
        <div class='panel-actions'>
            <button data-toggle="tooltip" data-original-title="Nova Forma de Pagamento" data-modulo="add" class="btn btn-xs btn-default btn-add"><i class="fa fa-plus"></i></button>
        </div>
    </div>
        ...
        <table class="table table-hover table-responsive mb-none" id="table-list" style="width: 100%;">
            <thead class="panel-featured panel-featured-custom text-custom">
                <tr>
                    ...
                    <th>NOME</th>
                    <th class="center col-xs-1">FINANCEIRO</th>
                    <th class="center col-xs-1">DESCONTO</th>
                    <th class="center col-xs-1">C. PAGAR</th>
                    <th class="center col-xs-1">C. RECEBER</th>
...
<script src="<?php echo site_url('assets/'); ?>javascripts/custom/common.js" data-route="formaspgto"></script>
<script src="<?php echo site_url('assets/'); ?>javascripts/custom/formas_pgto.js"></script>
<?php echo $this->endSection(); ?>