...
<section class="panel panel-featured panel-featured-custom">
    <div class="panel-heading">
        ...
        <div class='panel-actions'>
            <button data-toggle="tooltip" data-original-title="Nova Conta Corrente" data-modulo="add" class="btn btn-xs btn-default btn-add"><i class="fa fa-plus"></i></button>
        </div>
    </div>
...
<!-- begin modalForm -->
<div class="modal fade modal-header-color modal-block-warning" role="dialog" id="modalForm" data-backdrop="static" tabindex="-1">
...
<!-- begin modalAddBanco -->
<div class="modal modal-banco fade modal-header-color modal-block-warning" role="dialog" id="modalAddBanco" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered" style="min-width: 35%">
        <section class="panel">
            <header class="panel-heading">
                <h2 class="panel-title" id="modalAddBancoLabel"></h2>
            </header>
            <div class="panel-body modal-body-add-banco">
            </div>
            <footer class="panel-footer">
                <div class="row">
                    <div class="col-md-12 text-right">
                        <button type="button" class="btn btn-warning fixed-button-width modal-confirm-banco">Salvar</button>
                        <button type="button" class="btn btn-default fixed-button-width modal-dismiss-banco" data-dismiss="modal">Cancelar</button>
                    </div>
                </div>
            </footer>
        </section>
...
<script src="<?php echo site_url('assets/'); ?>javascripts/custom/common.js" data-route="contascorrente"></script>
<script src="<?php echo site_url('assets/'); ?>javascripts/custom/contas_corrente.js"></script>
<?php echo $this->endSection(); ?>