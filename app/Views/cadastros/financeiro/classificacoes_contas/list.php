...
<section class="panel panel-featured panel-featured-custom">
    <div class="panel-heading">
        ...
        <div class='panel-actions'>
            <button data-toggle="tooltip" data-original-title="Nova Classificação" data-modulo="add" class="btn btn-xs btn-default btn-add"><i class="fa fa-plus"></i></button>
        </div>
    </div>
...
<script src="<?php echo site_url('assets/'); ?>javascripts/custom/common.js" data-route="classificacoescontas"></script>
<script src="<?php echo site_url('assets/'); ?>javascripts/custom/classificacoes_contas.js"></script>
<?php echo $this->endSection(); ?>