...
<script src="<?php echo site_url('assets/'); ?>javascripts/custom/common.js" data-route="permissoes"></script>
<script src="<?php echo site_url('assets/'); ?>javascripts/custom/permissions.js"></script>
<?php echo $this->endSection(); ?>