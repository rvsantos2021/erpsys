...
<section class="panel panel-featured panel-featured-custom">
    <div class="panel-heading">
        ...
        <div class='panel-actions'>
            <button data-toggle="tooltip" data-original-title="Incluir" data-modulo="add" class="btn btn-xs btn-default btn-add"><i class="fa fa-plus"></i></button>
        </div>
    </div>
        ...
        <table class="table table-hover table-responsive mb-none" id="table-list" style="width: 100%;">
            <thead class="panel-featured panel-featured-custom text-custom">
                <tr>
                    ...
                    <th>NOME</th>
                    <th class="center col-xs-1">E-MAIL</th>
...
<div class="modal fade modal-header-color modal-block-warning" role="dialog" id="modalPhoto" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered" style="min-width: 30%">
        <?= $this->include('layout/modals/_modalphoto') ?>
    </div>
</div>
<!-- end modalPhoto -->

<!-- begin modalGroup -->
<div class="modal fade modal-header-color modal-block-warning" role="dialog" id="modalGroup" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered" style="min-width: 40%">
        <section class="panel">
            <header class="panel-heading">
                <h2 class="panel-title" id="modalGroupLabel"></h2>
            </header>
            <div class="panel-body modal-body-group">
            </div>
            <footer class="panel-footer">
                <div class="row">
                    <div class="col-md-12 text-right">
                        <button type="button" class="btn btn-warning fixed-button-width modal-confirm-group">Salvar</button>
                        <button type="button" class="btn btn-default fixed-button-width modal-dismiss-view" data-dismiss="modal">Cancelar</button>
                    </div>
                </div>
            </footer>
        </section>
...
<script src="<?php echo site_url('assets/'); ?>javascripts/custom/common.js" data-route="usuarios"></script>
<script src="<?php echo site_url('assets/'); ?>javascripts/custom/users.js"></script>
<?php echo $this->endSection(); ?>