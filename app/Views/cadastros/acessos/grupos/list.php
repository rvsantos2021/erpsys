        ...
        <table class="table table-hover table-responsive mb-none" id="table-list" style="width: 100%;">
            <thead class="panel-featured panel-featured-custom text-custom">
                <tr>
                    ...
                    <th>NOME</th>
                    <th>DESCRIÇÃO</th>
                    <th class="center col-xs-1">EXIBIR</th>
...
<!-- begin modalForm -->
<div class="modal fade modal-header-color modal-block-warning" role="dialog" id="modalPermission" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered" style="min-width: 40%">
        <section class="panel">
            <header class="panel-heading">
                <h2 class="panel-title" id="modalPermissionLabel"></h2>
            </header>
            <div class="panel-body modal-body-permission">
            </div>
            <footer class="panel-footer">
                <div class="row">
                    <div class="col-md-12 text-right">
                        <button type="button" class="btn btn-warning fixed-button-width modal-confirm-perm">Salvar</button>
...
<script src="<?php echo site_url('assets/'); ?>javascripts/custom/common.js" data-route="grupos"></script>
<script src="<?php echo site_url('assets/'); ?>javascripts/custom/groups.js"></script>
<?php echo $this->endSection(); ?>