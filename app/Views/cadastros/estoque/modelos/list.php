...
<script src="<?php echo site_url('assets/'); ?>javascripts/custom/common.js" data-route="modelos"></script>
<script src="<?php echo site_url('assets/'); ?>javascripts/custom/modelos.js"></script>
<?php echo $this->endSection(); ?>