...
<section class="panel panel-featured panel-featured-custom">
    <div class="panel-heading">
        ...
        <div class='panel-actions'>
            <button data-toggle="tooltip" data-original-title="Novo Tipo de Movimento" data-modulo="add" class="btn btn-xs btn-default btn-add"><i class="fa fa-plus"></i></button>
        </div>
    </div>
        ...
        <table class="table table-hover table-responsive mb-none" id="table-list" style="width: 100%;">
            <thead class="panel-featured panel-featured-custom text-custom">
                <tr>
                    ...
                    <th>DESCRIÇÃO</th>
                    <th class="col-xs-1">MOVIMENTO</th>
                    <th class="center col-xs-1">MOV. ESTOQUE</th>
...
<script src="<?php echo site_url('assets/'); ?>javascripts/custom/common.js" data-route="tiposmovimento"></script>
<script src="<?php echo site_url('assets/'); ?>javascripts/custom/tipos_movimento.js"></script>
<?php echo $this->endSection(); ?>