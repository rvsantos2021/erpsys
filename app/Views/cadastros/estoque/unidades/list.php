...
<section class="panel panel-featured panel-featured-custom">
    <div class="panel-heading">
        ...
        <div class='panel-actions'>
            <button data-toggle="tooltip" data-original-title="Nova Unidade" data-modulo="add" class="btn btn-xs btn-default btn-add"><i class="fa fa-plus"></i></button>
        </div>
    </div>
...
<script src="<?php echo site_url('assets/'); ?>javascripts/custom/common.js" data-route="unidades"></script>
<script src="<?php echo site_url('assets/'); ?>javascripts/custom/unidades.js"></script>
<?php echo $this->endSection(); ?>