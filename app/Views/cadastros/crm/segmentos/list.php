...
<script src="<?php echo site_url('assets/'); ?>javascripts/custom/common.js" data-route="segmentos"></script>
<script src="<?php echo site_url('assets/'); ?>javascripts/custom/crm/segmentos.js"></script>
<?php echo $this->endSection(); ?>