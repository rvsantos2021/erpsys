...
<section class="panel panel-featured panel-featured-custom">
    <div class="panel-heading">
        ...
        <div class='panel-actions'>
            <button data-toggle="tooltip" data-original-title="Novo Grupo Tributário" data-modulo="add" class="btn btn-xs btn-default btn-add"><i class="fa fa-plus"></i></button>
        </div>
    </div>
        ...
        <table class="table table-hover table-responsive mb-none" id="table-list" style="width: 100%;">
            <thead class="panel-featured panel-featured-custom text-custom">
                <tr>
                    ...
                    <th>DESCRIÇÃO</th>
                    <th class="col-xs-1">CST</th>
                    <th class="col-xs-1">TIPO</th>
                    <th class="col-xs-1 text-right">% ALIQUOTA</th>
                    <th class="col-xs-1 text-right">% REDUÇÃO</th>
...
<script src="<?php echo site_url('assets/'); ?>javascripts/custom/common.js" data-route="grupostributarios"></script>
<script src="<?php echo site_url('assets/'); ?>javascripts/custom/grupos_tributarios.js"></script>
<?php echo $this->endSection(); ?>