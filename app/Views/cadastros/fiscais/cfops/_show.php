                            ...
                            <div class="widget-profile-info">
                                ...
                                <div class="profile-info">
                                    ...
                                    <div class="profile-footer">
                                        <p>
                                            <strong>Status:</strong> <?php echo ($cfop->active == true ? '<span class="text-success">Ativo</span>' : '<span class="text-danger">Inativo</span>'); ?>
                                        </p>
                                        <p>
                                            <strong>Criação:</strong> <?php echo formatDateTime($cfop->created_at); ?>
                                        </p>
                                        <p>
