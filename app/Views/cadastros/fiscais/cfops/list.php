...
<section class="panel panel-featured panel-featured-custom">
    <div class="panel-heading">
        ...
        <div class='panel-actions'>
            <button data-toggle="tooltip" data-original-title="Novo CFOP" data-modulo="add" class="btn btn-xs btn-default btn-add"><i class="fa fa-plus"></i></button>
        </div>
    </div>
    <div class="panel-body">
        <table class="table table-hover table-responsive mb-none" id="table-list" style="width: 100%;">
            <thead class="panel-featured panel-featured-custom text-custom">
                <tr>
                    <th class="col-xs-1">CFOP</th>
                    <th>DESCRIÇÃO</th>
                    <th class="col-xs-2">ORIGEM / DESTINO</th>
...
<script src="<?php echo site_url('assets/'); ?>javascripts/custom/common.js" data-route="cfops"></script>
<script src="<?php echo site_url('assets/'); ?>javascripts/custom/cfops.js"></script>
<?php echo $this->endSection(); ?>