                ...
                <fieldset class="border pt-4 pb-4 pr-4 pl-4 mb-2 rounded">
                    <div class="pr-4 pl-4">
                        ...
                        <div class="row row-content">
                            <div class="col-md-1">
                                <span><?php echo $empresa->id; ?></span>
                            </div>
                            <div class="col-md-2">
                                <span><?php echo $empresa->cnpj; ?></span>
                            </div>
                            <div class="col-md-2">
                                <span><?php echo $empresa->inscricao_estadual; ?></span>
                            </div>
                            <div class="col-md-6">

                            </div>
                            <div class="col-md-1">
                                <?php echo ($empresa->active == true ? '<span class="text-success">ATIVO</span>' : '<span class="text-danger">INATIVO</span>'); ?>
                            </div>
                        </div>
                        ...
                        <div class="row row-content">
                            ...
                            <div class="col-md-3">
                                <span><?php echo $empresa->celular; ?></span>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="row row-title">
                            <div class="col-md-6">
                                <span class="text-bold">SITE</span>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="row row-content">
                            <div class="col-md-6">
                                <span><?php echo $empresa->site; ?></span>
                            </div>
                            <div class="col-md-6">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <span class="text-primary">
                            <i class="fas fa-clock"></i><strong> Última Atualização:</strong> <?php echo formatDateTime($empresa->updated_at); ?>
                        </span>
                    </div>
                </div>
            </div>