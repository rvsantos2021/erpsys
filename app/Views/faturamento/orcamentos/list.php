...
<section class="panel panel-featured panel-featured-custom">
    <div class="panel-heading">
        ...
        <div class='panel-actions'>
            <button data-toggle="tooltip" data-original-title="Novo Segmento" data-modulo="add" class="btn btn-xs btn-default btn-add"><i class="fa fa-plus"></i></button>
        </div>
    </div>
...
<!-- begin modalEtapa -->
<div class="modal fade modal-header-color modal-block-warning" role="dialog" id="modalEtapa" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered" style="min-width: 40%">
        <section class="panel">
            <header class="panel-heading">
                <h2 class="panel-title" id="modalEtapaLabel"></h2>
            </header>
            <div class="panel-body modal-body-etapa">
            ...
            <footer class="panel-footer">
                <div class="row">
                    <div class="col-md-12 text-right">
                        <button type="button" class="btn btn-warning fixed-button-width modal-confirm-etapa">Salvar</button>
...
<script src="<?php echo site_url('assets/'); ?>javascripts/custom/common.js" data-route="funil"></script>
<script src="<?php echo site_url('assets/'); ?>javascripts/custom/crm/funil.js"></script>
<?php echo $this->endSection(); ?>