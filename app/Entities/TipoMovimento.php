...
class TipoMovimento extends Entity
{
    protected $entity = 'Tipo de Movimento';
    ...
    /**
     * Método que controla o label do tipo de movimento
     * @return string
     */
    public function labelMovimentoControl()
    {
        if ($this->movimento == 'E') {
            if (APP_THEME == 'mentor') {
                $return = '<span class="btn btn-sm btn-icon btn-round btn-inverse-success" title="Entrada">E</i></span>';
            }
            else {
                $return = 'Entrada';
            }
        } else if ($this->movimento == 'S') {
            if (APP_THEME == 'mentor') {
                $return = '<span class="btn btn-sm btn-icon btn-round btn-inverse-danger" title="Saída">S</i></span>';
            } else {
                $return = 'Saída';
            }
        } else if ($this->movimento == 'T') {
            if (APP_THEME == 'mentor') {
                $return = '<span class="btn btn-sm btn-icon btn-round btn-inverse-warning" title="Transferência">T</i></span>';
            } else {
