...
class MovimentoEstoque extends Entity
{
    protected $dates = [
        'created_at',
        'updated_at',
    ...
    public function buttonsControl()
    {
        if (APP_THEME == 'mentor') {
            ...
            $btnDelete = '<button data-toggle="tooltip" data-original-title="Excluir" title="Excluir" data-id="' . $this->id . '" class="btn btn-xs btn-default text-danger btn-width-27 btn-del"><i class="fas fa-trash-alt"></i></button>';
            $btnRestore = '<button data-toggle="tooltip" data-original-title="Restaurar" title="Restaurar" data-id="' . $this->id . '" class="btn btn-xs btn-default text-success btn-width-27 btn-undo"><i class="fa fa-undo"></i></button>';
        }
